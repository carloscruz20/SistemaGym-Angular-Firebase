  ...
  seleccionarPrecio(id:string){
    ...
    if(id!="null"){
      ...
      if(this.precioSeleccionado.tipoDuracion==1){
        ...
        let fechaFinal=
        new Date(this.inscripcion.fecha.getFullYear(),this.inscripcion.fecha.getMonth(),this.inscripcion.fecha.getDate()+dias)    //0 enero , 1 febrero .... 11 diciembre
      ...
      if(this.precioSeleccionado.tipoDuracion==4){
        ...
        let fechaFinal=new Date(anio,meses,dia)    //0 enero , 1 febrero .... 11 diciembre
        this.inscripcion.fechaFinal=fechaFinal
      }
